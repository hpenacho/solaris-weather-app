...
const HeaderSection = ({ theme, setTheme }) => {
    ...
    const AboutThisProject = {
        ...
        content: <DialogContentText id="aboutthisproject-description">
            badabingbadabong badabingbadabong badabingbadabong badabingbadabong badabingbadabongbadabingbadabong
        </DialogContentText>
    }
